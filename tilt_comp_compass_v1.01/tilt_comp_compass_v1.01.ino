...
int     Mag_x_offset = -106,      Mag_y_offset = 403,     Mag_z_offset = -379;   // Hard-iron offsets
float   Mag_x_scale = 1.02,     Mag_y_scale = 1.00,     Mag_z_scale = 0.98;    // Soft-iron scale factors
